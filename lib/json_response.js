...
var responses = {
    ...
    "apaGetMemberStats": function (_idx) {
        return (_idx === 0 ? JSON.stringify(telemouv.getMemberStats()) : nope(_idx));
    },
    ...
    "apaSearchMember": function (_idx) {
        return (_idx === 0 ? JSON.stringify(telemouv.getProfilesByEmail()) : nope(_idx));
    }
};
